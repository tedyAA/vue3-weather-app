<template>
  ...
  <div class="weather-wrap" v-else>
    <div class="text-center">
      ...
      <div class="text-white text-[20px] font-light italic text-center">{{ dateBuilderDDMY() }}
      </div>
    </div>
    <div class="flex justify-center">
      <div
        class="w-fit px-[35px] py-[10px] text-white text-[70px] md:text-[102px] font-black shadow-[3px_6px_rgba(0,0,0,0.25)] bg-[rgba(255,255,255,0.25)] rounded-[16px] my-[30px]">
        <div class="flex justify-center">
          <img
        ...
        <p class="text-xl text-center font-bold">Feels Like {{ feelsLikeTemp }}°C</p>
      </div>
    </div>
...
<script setup>
// Weather component that displays weather city, date, weather icon, temperature,
