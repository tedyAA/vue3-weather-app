<template>
  ...
  <div class="weather-wrap" v-else>
    ...
    <div class="flex justify-center">
      <div class="flex justify-center w-fit px-[35px] py-[10px] text-white text-md-[102px] text-[70px] font-black shadow-[3px_6px_rgba(0,0,0,0.25)] bg-[rgba(255,255,255,0.25)] rounded-[16px] my-[30px]">
        <img
