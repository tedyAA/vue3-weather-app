<template>
  <div class="flex justify-center">
    ...
    <div v-else class="flex py-2 px-6 shadow-[3px_6px_rgba(0,0,0,0.25)] bg-[rgba(255,255,255,0.25)] rounded-[32px] w-fit justify-center">
      <div class="flex">
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-sunrise text-white w-5 h-5 md:w-[50px] md:h-[50px] my-auto" viewBox="0 0 16 16">
      ...
      <span class="ml-1 mr-1"/>
      <div class="flex">
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-sunset text-white w-5 h-5 md:w-[50px] md:h-[50px] my-auto" viewBox="0 0 16 16">
        ...
        <span class="ml-1 mr-1"/>
        <p class="text-white md:text-2xl my-auto">{{timeBuilder(sunset)}}</p>
      </div>
    </div>
  </div>
</template>
